...
// archivo de texto cuyo nombre se le pasará por parámetro al constructor. Este archivo debe contener varias
// palabras en español y su traducción al inglés, de tal forma que las palabras en español sean la clave,
...
public class Ejercicio4 {
    public static void main(String[] args) {
        Traductor t1 = new Traductor("src/main/java/U7/Tarea3/Diccionario.txt");
        System.out.println(t1);
        t1.traducirPalabra("hola");
        t1.traducirPalabra("gracias");
    }
}
